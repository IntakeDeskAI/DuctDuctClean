...
export const blogPosts: BlogPost[] = [
  {
    slug: "how-often-should-you-clean-air-ducts-idaho",
    title: "How Often Should You Clean Your Air Ducts in Idaho?",
    excerpt:
    ...
    keywords: [
      ...
      "Idaho air duct cleaning",
      "Idaho Falls HVAC maintenance",
      "how often clean air ducts",
      "indoor air quality Idaho",
    ],
    sections: [
      {
        heading: "The National Recommendation",
        content:
          "The National Air Duct Cleaners Association (NADCA) recommends having your air ducts professionally cleaned every 3 to 5 years. However, this is a general guideline — your home's specific conditions can shorten or lengthen that timeline significantly.",
      },
      {
        heading: "Why Idaho Homes May Need More Frequent Cleaning",
        content:
      ...
      {
        heading: "Signs Your Ducts Need Cleaning Now",
        content:
          "Regardless of the timeline, certain signs indicate your ducts need immediate attention. Watch for these common indicators:",
        list: [
          ...
          "Dust buildup on furniture returns quickly after cleaning",
          "Uneven airflow between rooms",
          "Higher than normal energy bills",
        ],
      },
      {
        heading: "Situations That Call for Earlier Cleaning",
        content:
          "Some circumstances mean you should schedule duct cleaning sooner rather than later, even if it hasn't been three years:",
        list: [
          "After a home renovation or remodeling project",
          "Moving into a new or previously owned home",
          "After a wildfire season with heavy smoke exposure",
          "If you have pets, especially those that shed heavily",
          "Smokers in the household",
          "Family members with respiratory conditions",
        ],
      },
      {
        heading: "The Bottom Line for Idaho Falls Homeowners",
        content:
  ...
  {
    slug: "dryer-vent-fire-prevention-tips",
    title: "Dryer Vent Safety: How to Prevent House Fires in Your Idaho Home",
    excerpt:
    ...
    keywords: [
      ...
      "Idaho Falls dryer vent",
      "clogged dryer vent signs",
      "dryer vent safety",
    ],
    sections: [
      {
        heading: "A Hidden Danger in Your Home",
        content:
      ...
      {
        heading: "Warning Signs of a Clogged Dryer Vent",
        content:
      ...
      {
        heading: "Why Idaho Winters Make This Worse",
        content:
      ...
      {
        heading: "DIY Maintenance Between Professional Cleanings",
        content:
  ...
  {
    slug: "improve-indoor-air-quality-eastern-idaho",
    title:
    ...
    keywords: [
      "indoor air quality",
      "Eastern Idaho air quality",
      "improve home air quality",
      "Idaho Falls allergens",
      "HVAC air quality tips",
    ],
    sections: [
      {
      ...
      {
        heading: "1. Schedule Professional Air Duct Cleaning",
        content:
      ...
      {
        heading: "2. Upgrade Your HVAC Filters",
        content:
      ...
      {
        heading: "3. Control Humidity Levels",
        content:
      ...
      {
        heading: "5. Reduce Indoor Pollutant Sources",
        content:
      ...
      {
        heading: "Start With a Professional Assessment",
        content:
